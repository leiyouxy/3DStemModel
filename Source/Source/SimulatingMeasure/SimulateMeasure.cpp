...
void CSimulateMeasure::StemDividingByStemAxisCurve()
{
	...
	while (CurHeight < TempHeight)
	{
		...
		cout << "CurHeight:" << CurHeight <<", No Point AngleZone Count:"<< AngleCount << endl;
		...
		if (!(AngleCount > 30 / AngleValue))
		{
			...
			PointBase::SaveToVTX(Temp2DSectionPoints, "I:\\000Comparsion\\FinalSlice20201109\\"
				+ FileName + "_Data_" + StringBase::IntToStr(i) + "_" 
	...
	cout << "Stem Dividing By Stem Axis Curve has been done!" << endl;
}
...
void CSimulateMeasure::BatStemDividing()
{
	...
	for each (string FileNameStr in BatFiles)
	{
			...
			|| (strcmp(Ext, ".las") == 0))
		{
			...
			cout<<"Current Processing file name:"<< OpenedFilePath <<endl << endl;
...
void CSimulateMeasure::CaliperMeasure()
{
	...
	//PointBase::SavePCDToFileName(D2PlanarPoints, "I:\\000Comparsion\\Final\\D2PlanarPointsForCaliper.pcd");
	//PointBase::SavePCDToFileName(D2ConvexHullPoints, "I:\\000Comparsion\\Final\\ConvexHullPointsForCaliper.pcd");
